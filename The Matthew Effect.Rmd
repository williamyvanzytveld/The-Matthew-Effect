...
```{r}
fifa_cleaning <- function(csv_file, fifa_year){
  name <- read_csv(csv_file)
  name <- name %>% 
    mutate(fifa_year = fifa_year,
           year = year(ymd(dob)),
...
fifa_players_15 <- fifa_cleaning("data/players_15.csv", 2015)
fifa_players_16 <- fifa_cleaning("data/players_16.csv", 2016)
fifa_players_17 <- fifa_cleaning("data/players_17.csv", 2017)
fifa_players_18 <- fifa_cleaning("data/players_18.csv", 2018)
fifa_players_19 <- fifa_cleaning("data/players_19.csv", 2019)
fifa_players_20 <- fifa_cleaning("data/players_20.csv", 2020)
fifa_players_21 <- fifa_cleaning("data/players_21.csv", 2021)
